...
//		log.info(
//				mockMvc.perform(MockMvcRequestBuilders.get("/board/get").param("bno", "3")).andReturn().getModelAndView().getModelMap()
//		);
//	}
//	
//	@Test
...
//				param("bno", "4").param("title", "수정된 컨트롤러 새글 제목").param("content", "수정된 컨트롤러 새글 내용").param("writer", "user00")).andReturn().getModelAndView().getViewName();
//		
//		log.info(resultPage);
//	}
...
//		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", "6")).andReturn().getModelAndView().getViewName();
//		
//		log.info(resultPage);
//	}
